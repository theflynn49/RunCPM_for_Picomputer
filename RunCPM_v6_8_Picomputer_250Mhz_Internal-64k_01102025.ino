...
// =========================================================================================
 ...
 // tft.setFont(&Font5x7FixedMono) ;
  ...
  _puts("CP/M Emulator v" VERSION "\e[0m   by   \e[1mMarcelo  Dantas\e[0m\r\n");
...
//  _puts("     running    on   Raspberry Pi  [\e[1mPico-W\e[0m]\r\n");
  _puts("     compiled with   RP2040        [\e[1mv5.2.1\e[0m] \r\n");  
//  _puts("               and   ESP8266SdFat [\e[1mv2.2.2\e[0m] \r\n");
  _puts("                     SDFat         [\e[1mv2.3.0\e[0m] \r\n");  
  _puts("                     GFX           [\e[1mv1.12.3\e[0m] \r\n");  
